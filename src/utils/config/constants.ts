...
export const LINKS = {
  website: 'https://gotx.io',
  webapp: 'https://app.gotx.io',
  baseTelegram: 'https://t.me',
  docs: 'https://docs.gotx.io/',
  github: 'https://github.com/gotx-io',
  twitter: 'https://twitter.com/gotx_io',
}
...
export const MIN_PARSE_ETHER = 0.000001
