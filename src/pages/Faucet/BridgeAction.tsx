...
import { MODE_TESTNET, SEPOLIA } from 'utils/web3/chains'
...
const BridgeAction = () => {
  ...
  const { isTokenAllowanceEnough, approving, approveToken } = useERC20Approval({
    token: CONTRACT_ADDRESSES[SEPOLIA][CONTRACT_KEYS.USDC],
    ...
    mutate(
      {
        method: 'bridgeERC20',
        params: [
          CONTRACT_ADDRESSES[SEPOLIA][CONTRACT_KEYS.USDC],
          CONTRACT_ADDRESSES[MODE_TESTNET][CONTRACT_KEYS.USDC],
          parseEther('10000'),
          500000, // gas limit
          0,
        ],
